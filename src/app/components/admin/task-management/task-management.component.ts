...
export class TaskManagementComponent implements OnInit {
  teams: TeamTaskData[] = [
    { id: 1, name: 'Development Team', completedTasks: 0, pendingTasks: 0, totalTasks: 0, color: '#4CAF50', departmentId: '001',duration: '1h' },
    { id: 2, name: 'Marketing Team', completedTasks: 0, pendingTasks: 0, totalTasks: 0, color: '#2196F3', departmentId: '002', duration: '2h' },
    { id: 3, name: 'Sales Team', completedTasks: 0, pendingTasks: 0, totalTasks: 0, color: '#9C27B0', departmentId: '003', duration: '1h' },
    { id: 4, name: 'Operation Team', completedTasks: 0, pendingTasks: 0, totalTasks: 0, color: '#FF5722', departmentId: '004',  duration: '3h' },
    { id: 5, name: 'Design Team', completedTasks: 0, pendingTasks: 0, totalTasks: 0, color: '#FFC107', departmentId: '005', duration: '4h' },
    { id: 6, name: 'HR Team', completedTasks: 0, pendingTasks: 0, totalTasks: 0, color: '#607D8B', departmentId: '006' , duration: '2h' },
  ];
  ...
  viewTeamTasks(team: TeamTaskData): void {
    ...
    this.taskService.getAllPriorityCountsForTeam(team.departmentId).subscribe(priorityCounts => {
